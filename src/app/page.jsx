   ...
   <>
           <>
            ...
            <div className='bg-[#FF4B91] md:flex flex py-7 px-7 md:py-9 mt-16 justify-between'>
                ...
                <div className='md:w-1/2'>
                <Image
               className='md:h-52 mx-auto rounded'
                    src={'/img4.png'}
                    width={300}
                    height={200}
                    />
